...
void comec(int tabuleiro[][3]);               // incializa o tabuleiro com zeros
...
void placar(int, int jogador1, int jogador2); // mostra o placar
int main()
{
    int tabuleiro[3][3];
...
int vitoria(int tabuleiro[][3]) // verifica se alguém venceu
{
    ...
    for (linha = 0; linha < 3; linha++) // percorre as linhas
    {
        ...
        if (verif == 3) // se a soma for 3, o jogador 1 venceu
            return 1;
        else if (verif == -3) // se a soma for -3, o jogador 2 venceu
            return -1;
    }
    ...
    for (coluna = 0; coluna < 3; coluna++) // percorre as colunas
    {
        ...
        if (verif == 3)                        // se a soma for 3, o jogador 1 venceu
            return 1;
        if (verif == -3) // se a soma for -3, o jogador 2 venceu
            return -1;
    }
...
int jogo(int tabuleiro[][3]) // roda o jogo
{
    ...
    else if (vence == -1) // verifica se o jogador 2 venceu
    {
        cout << "Jogador 2 venceu!" << endl;
        return 2;
    }
    else
        cout << "Nao ha vencedores!" << endl;
    return 0;
}
